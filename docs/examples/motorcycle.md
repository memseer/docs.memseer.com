...
Additionally, if you'd like to inspect the chain more often during certain seasons — say, when conditions are tougher or the usage is higher — you can add another action such as "Inspect chain every 2 months between August and November."
